...
namespace Fuse.Controls
{
	internal class DefaultTreeRenderer : ITreeRenderer
	{
		...
		public void ZOrderChanged(Element e, IEnumerable<Visual> zorder) {}
	...
	*/
	public partial class GraphicsView: IViewport, IRenderViewport, ITreeRenderer, IProxyHost
	{
		...
		void ITreeRenderer.ZOrderChanged(Element e, IEnumerable<Visual> zorder) { /*GetTreeRenderer(e).ZOrderChanged(e, zorder);*/ }
